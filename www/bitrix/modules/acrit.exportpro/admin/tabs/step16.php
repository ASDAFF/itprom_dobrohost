...
<tr>
    ...
    <td width="60%" class="adm-detail-content-cell-r" id="ozon_app_id">
        <input type="text" size="30" name="PROFILE[OZON_APPID]" name="ozonAppId" value="<?=$arProfile["OZON_APPID"];?>" />
    </td>
</tr>
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
    ...
    <td width="60%" class="adm-detail-content-cell-r" id="ozon_app_key">
        <input type="text" size="30" name="PROFILE[OZON_APPKEY]" name="ozonAppKey" value="<?=$arProfile["OZON_APPKEY"];?>" />
    </td>
</tr>