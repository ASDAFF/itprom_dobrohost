...
<tr>
	<td width="50%"><?=GetMEssage('ACRIT_EXPORTPRO_VARIANT_LIST_USE_VARIANT')?></td>
	<td width="50%">
...
<tr>
	<td width="50%"><?=GetMessage('ACRIT_EXPORTPRO_VARIANT_LIST_SEX')?></td>
	<td width="50%">
...
<tr>
	<td width="50%"><?=GetMessage('ACRIT_EXPORTPRO_VARIANT_LIST_SEX_OFFER')?></td>
	<td width="50%">
...
<tr>
    <td width="50%"><?=GetMessage('ACRIT_EXPORTPRO_VARIANT_LIST_SEX_CONST')?></td>
    <td width="50%">
...
<tr>
	<td width="50%"><?=GetMessage('ACRIT_EXPORTPRO_VARIANT_LIST_COLOR')?></td>
	<td width="50%">
...
<tr>
	<td width="50%"><?=GetMessage('ACRIT_EXPORTPRO_VARIANT_LIST_COLOR_OFFER')?></td>
	<td width="50%">
...
<tr>
	<td width="50%"><?=GetMessage('ACRIT_EXPORTPRO_VARIANT_LIST_SIZE')?></td>
	<td width="50%">
...
<tr>
	<td width="50%"><?=GetMessage('ACRIT_EXPORTPRO_VARIANT_LIST_SIZE_OFFER')?></td>
	<td width="50%">
...
<tr>
    <td width="50%"><?=GetMessage('ACRIT_EXPORTPRO_VARIANT_LIST_WEIGHT')?></td>
    <td width="50%">
...
<tr>
    <td width="50%"><?=GetMessage('ACRIT_EXPORTPRO_VARIANT_LIST_WEIGHT_OFFER')?></td>
    <td width="50%">
...
<tr>
	<td width="50%"><?=GetMessage('ACRIT_EXPORTPRO_VARIANT_LIST_PRICE')?></td>
	<td width="50%">
