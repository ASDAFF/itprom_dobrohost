...
class CAcritExportproCond extends CCatalogCondCtrlIBlockFields{
	...
	public static function GetControls($strControlID = false)
	{
		...
		while ($arPriceType = $dbPriceType->GetNext()){
			...
			$arControlList['CondCatPrice_'.$arPriceType["ID"]] = array(
				...
				'GROUP' => 'N',
				'LABEL' => $priceName,
				'PREFIX' => $priceName, //str_replace("#PRICE#", $arPriceType["NAME_LANG"], GetMessage('BT_MOD_CATALOG_COND_CMP_CATALOG_PRICE_PREFIX')),
			...
			$arControlList['CondCatPrice_'.$arPriceType["ID"].'_WD'] = array(
				...
				'GROUP' => 'N',
				'LABEL' => $priceNameWD,
				'PREFIX' => $priceNameWD, //str_replace("#PRICE#", $arPriceType["NAME_LANG"], GetMessage('BT_MOD_CATALOG_COND_CMP_CATALOG_PRICE_PREFIX')),
				'LOGIC' => static::GetLogic(array(BT_COND_LOGIC_EQ, BT_COND_LOGIC_NOT_EQ, BT_COND_LOGIC_GR, BT_COND_LOGIC_LS, BT_COND_LOGIC_EGR, BT_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			$arControlList['CondCatPrice_'.$arPriceType["ID"].'_D'] = array(
				...
				'GROUP' => 'N',
				'LABEL' => $priceNameD,
				'PREFIX' => $priceNameD, //str_replace("#PRICE#", $arPriceType["NAME_LANG"], GetMessage('BT_MOD_CATALOG_COND_CMP_CATALOG_PRICE_PREFIX')),
				'LOGIC' => static::GetLogic(array(BT_COND_LOGIC_EQ, BT_COND_LOGIC_NOT_EQ, BT_COND_LOGIC_GR, BT_COND_LOGIC_LS, BT_COND_LOGIC_EGR, BT_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
